(function (ZCArea, ZCBar, ZCBoxplot, ZCBubble, ZCBubblePie, ZCBullet, ZCCalendar, ZCChord, ZCColumn, ZCFunnel, ZCGauge, ZCHeatmap, ZCLine, ZCMap, ZCNestedPie, ZCNetworkDiagram, ZCPareto, ZCPie, ZCPopulationPyramid, ZCRadar, ZCRankflow, ZCScatter, ZCTreemap, ZCVenn, ZCWaterfall, ZCWordcloud) {
  'use strict';

  ZCArea = ZCArea && ZCArea.hasOwnProperty('default') ? ZCArea['default'] : ZCArea;
  ZCBar = ZCBar && ZCBar.hasOwnProperty('default') ? ZCBar['default'] : ZCBar;
  ZCBoxplot = ZCBoxplot && ZCBoxplot.hasOwnProperty('default') ? ZCBoxplot['default'] : ZCBoxplot;
  ZCBubble = ZCBubble && ZCBubble.hasOwnProperty('default') ? ZCBubble['default'] : ZCBubble;
  ZCBubblePie = ZCBubblePie && ZCBubblePie.hasOwnProperty('default') ? ZCBubblePie['default'] : ZCBubblePie;
  ZCBullet = ZCBullet && ZCBullet.hasOwnProperty('default') ? ZCBullet['default'] : ZCBullet;
  ZCCalendar = ZCCalendar && ZCCalendar.hasOwnProperty('default') ? ZCCalendar['default'] : ZCCalendar;
  ZCChord = ZCChord && ZCChord.hasOwnProperty('default') ? ZCChord['default'] : ZCChord;
  ZCColumn = ZCColumn && ZCColumn.hasOwnProperty('default') ? ZCColumn['default'] : ZCColumn;
  ZCFunnel = ZCFunnel && ZCFunnel.hasOwnProperty('default') ? ZCFunnel['default'] : ZCFunnel;
  ZCGauge = ZCGauge && ZCGauge.hasOwnProperty('default') ? ZCGauge['default'] : ZCGauge;
  ZCHeatmap = ZCHeatmap && ZCHeatmap.hasOwnProperty('default') ? ZCHeatmap['default'] : ZCHeatmap;
  ZCLine = ZCLine && ZCLine.hasOwnProperty('default') ? ZCLine['default'] : ZCLine;
  ZCMap = ZCMap && ZCMap.hasOwnProperty('default') ? ZCMap['default'] : ZCMap;
  ZCNestedPie = ZCNestedPie && ZCNestedPie.hasOwnProperty('default') ? ZCNestedPie['default'] : ZCNestedPie;
  ZCNetworkDiagram = ZCNetworkDiagram && ZCNetworkDiagram.hasOwnProperty('default') ? ZCNetworkDiagram['default'] : ZCNetworkDiagram;
  ZCPareto = ZCPareto && ZCPareto.hasOwnProperty('default') ? ZCPareto['default'] : ZCPareto;
  ZCPie = ZCPie && ZCPie.hasOwnProperty('default') ? ZCPie['default'] : ZCPie;
  ZCPopulationPyramid = ZCPopulationPyramid && ZCPopulationPyramid.hasOwnProperty('default') ? ZCPopulationPyramid['default'] : ZCPopulationPyramid;
  ZCRadar = ZCRadar && ZCRadar.hasOwnProperty('default') ? ZCRadar['default'] : ZCRadar;
  ZCRankflow = ZCRankflow && ZCRankflow.hasOwnProperty('default') ? ZCRankflow['default'] : ZCRankflow;
  ZCScatter = ZCScatter && ZCScatter.hasOwnProperty('default') ? ZCScatter['default'] : ZCScatter;
  ZCTreemap = ZCTreemap && ZCTreemap.hasOwnProperty('default') ? ZCTreemap['default'] : ZCTreemap;
  ZCVenn = ZCVenn && ZCVenn.hasOwnProperty('default') ? ZCVenn['default'] : ZCVenn;
  ZCWaterfall = ZCWaterfall && ZCWaterfall.hasOwnProperty('default') ? ZCWaterfall['default'] : ZCWaterfall;
  ZCWordcloud = ZCWordcloud && ZCWordcloud.hasOwnProperty('default') ? ZCWordcloud['default'] : ZCWordcloud;
  ...
  */
  ...
  customElements.define('zc-boxplot', ZCBoxplot);
  customElements.define('zc-bubble', ZCBubble);
  customElements.define('zc-bubble-pie', ZCBubblePie);
  customElements.define('zc-bullet', ZCBullet);
  customElements.define('zc-calendar', ZCCalendar);
  customElements.define('zc-chord', ZCChord);
  customElements.define('zc-column', ZCColumn);
  customElements.define('zc-funnel', ZCFunnel);
  customElements.define('zc-gauge', ZCGauge);
  customElements.define('zc-heatmap', ZCHeatmap);
  customElements.define('zc-line', ZCLine);
  customElements.define('zc-map', ZCMap);
  customElements.define('zc-nested-pie', ZCNestedPie);
  customElements.define('zc-network-diagram', ZCNetworkDiagram);
  customElements.define('zc-pareto', ZCPareto);
  customElements.define('zc-pie', ZCPie);
  customElements.define('zc-population-pyramid', ZCPopulationPyramid);
  customElements.define('zc-radar', ZCRadar);
  customElements.define('zc-rankflow', ZCRankflow);
  customElements.define('zc-scatter', ZCScatter);
  customElements.define('zc-treemap', ZCTreemap);
  customElements.define('zc-treemap', ZCVenn);
  customElements.define('zc-waterfall', ZCWaterfall);
  customElements.define('zc-wordcloud', ZCWordcloud);

}(ZCArea, ZCBar, ZCBoxplot, ZCBubble, ZCBubblePie, ZCBullet, ZCCalendar, ZCChord, ZCColumn, ZCFunnel, ZCGauge, ZCHeatmap, ZCLine, ZCMap, ZCNestedPie, ZCNetworkDiagram, ZCPareto, ZCPie, ZCPopulationPyramid, ZCRadar, ZCRankflow, ZCScatter, ZCTreemap, ZCVenn, ZCWaterfall, ZCWordcloud));
